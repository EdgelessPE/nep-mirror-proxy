...
export const Hero = () => {
    ...
    return (
        <section
            className="w-screen  flex justify-center items-center bg-bgDark1 mb-0 hero-bg-gradient pb-24 sm:pb-32 md:pb-44 lg:pb-0" style={{height:'100vh'}}
            id="home"
        >
            <div
                className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center text-center">
                <motion.div
                ...
                >
                    <div className="mt-10 px-4 py-2 backdrop-blur-lg rounded-xl"
                         style={{background: 'rgb(40,44,52)', color: 'rgb(191 193 201 / 1)'}}>
                        <div className="group h-full flex items-center">
                            <svg width="22" height="13" viewBox="0 0 22 13" fill="none"
                                 xmlns="http://www.w3.org/2000/svg"
                                 className="mr-2 relative block w-3 -rotate-90" aria-hidden="true">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    title="Copy to clipboard" onClick={onCopy}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="size-5" viewBox="0 0 24 24">
                                        <path fill="currentColor"
                                              d="M7 6V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1.001 1.001 0 0 1 3 21l.003-14c0-.552.45-1 1.006-1zM5.002 8L5 20h10V8zM9 6h8v10h2V4H9z"></path>
                                    </svg>
                                </button>
                                <p
                                    ...
                                    data-visible={showTip} aria-hidden="true">
                                    已复制！
                                </p></div>
                        </div>
                    </div>
